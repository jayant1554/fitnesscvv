...
class WorkoutPlannerSystem:
    def __init__(self):
        # Load config list if you still want to use it
        self.config_list = config_list_from_json(
            env_or_file="OAI_CONFIG_LIST.json"
        )

        # Use Groq instead of Mistral
        self.llm_config = {
            "model": "groq/compound",   # or "deepseek-r1-distill-llama-70b"
            "api_key": "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",  # put your Groq API key here
            "base_url": "https://api.groq.com/openai/v1",
            "max_tokens": 8192,   # safe value (adjust depending on model page)
            "temperature": 0.3
        }
