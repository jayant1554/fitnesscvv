...
from simple_workout_generator import SimpleWorkoutPlannerSystem  # Use simple version instead
import json
import ast
# import pdfkit  # Commented out as it may cause issues
from flask import send_file
import io

app = Flask(__name__)
app.secret_key = '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'  # Replace with a real secret key
...
def workout_plan():
    ...
    plan = SimpleWorkoutPlannerSystem().generate_plan(user_data)
